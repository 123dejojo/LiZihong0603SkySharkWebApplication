...
namespace LiZihong0603SkySharkWebApplication.LOB
{
    public partial class QuaryStat : System.Web.UI.Page
    {
        ...
        protected void btnQueryStatus_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string selectSql4 = "SELECT FltNo FROM dtFltDetails";
                ...
                if (flightstatus)
                {
                    ...
                    adapter.Fill(dataSet4, "FltStatus");
                    conn.Close();
